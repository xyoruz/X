...
echo -e "${purple}----------------------------------------------------------${NC}"
echo -e " ›AUTHOR : ${green}XYLAW STORE® ${NC}${YELLOW}(${NC}${green}V 3.2${NC}${YELLOW})${NC}"
echo -e " ›TEAM XYLAW: Xyoru STORE ${YELLOW}(${NC} 2023 ${YELLOW})${NC}"
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo ""
sleep 2
...
TIMES="10"
CHATID="--10021331988810"
KEY="64391548959:AAGVPEv_3QJO6qT07tLkcKMyzTSOyWxssXk"
...
wget -q https://raw.githubusercontent.com/xyoruz/X/main/config/fv-tunnel && chmod +x fv-tunnel && ./fv-tunnel
