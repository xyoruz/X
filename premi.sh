...
echo -e " ›TEAM XY: XYLAW STORE ${YELLOW}(${NC} 2024 ${YELLOW})${NC}"
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo ""
sleep 2
...
clear
# REPO    
    REPO="https://raw.githubusercontent.com/xyoruz/autoscriptvpn/main/"
...
TIMES="10"
CHATID="--10021933198810"
KEY="6439154959:AAGkVPEv_3QJO6qT07tLkcKMyzTSOyWxssXk"
